...
export const PROJECTS = [
  {
    ...
    links: [
      {
        label: "Front-end",
        url: "https://github.com/regaaron/ProyectoSeminario",
      },
  ...
  },
  {
    ...
    links: [
      {
        label: "GitHub",
        url: "https://github.com/regaaron/java/tree/main/PlantasVsZombies",
      },
    ],
    images: ["/zombies.png"],
  },
        ...
        >
          <div className="flex items-start gap-4 mb-4">
            ...
            <div className="flex-1">
              {/* Badge ahora está aquí arriba, inline con el título */}
              ...
              <p className="text-white/40 text-sm">{featured.subtitle}</p>
              <p className="font-mono text-[11px] text-white/20 mt-1">
                {featured.period}
              </p>
            </div>

            {/* Toggle solo, sin competir con nadie */}
            <ExpandToggle isOpen={selected === featured.id} />
          </div>
                ...
                >
                  <div className="flex justify-between mb-4">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <ExpandToggle isOpen={selected === project.id} />
                    </div>
                  </div>
              ...
              return (
                ...
                >
                  ...
                  {proj.image ? (
                    ...
                    <div
                      className={`w-full h-24 ${c.bg} flex items-center justify-center opacity-40`}
                    >
                      <svg
                  ...
                  <div className="p-4 flex flex-col gap-2 flex-1">
                    ...
                    <div className="flex flex-wrap gap-1.5 mt-1">
                      {proj.tags.map((t) => (
                        <Badge key={t} color={proj.color as ColorKey}>
                          {t}
                        </Badge>
                      ))}
                    </div>
